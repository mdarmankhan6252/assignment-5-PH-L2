...
const updateParcelStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isParcelExist = yield parcel_model_1.default.findById(id);
    if ((isParcelExist === null || isParcelExist === void 0 ? void 0 : isParcelExist.currentStatus) === 'CANCELLED') {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, "The status is not changeable now!");
    }
...
const getParcelById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const parcel = yield parcel_service_1.ParcelServices.getParcelById(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: "Parcel is retrieved successfully",
...
const getParcelByEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const email = req.params.email;
    const parcel = yield parcel_service_1.ParcelServices.getParcelByEmail(email);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: "Parcel is retrieved successfully",
